...
class MultTime2dMixer(nn.Module):
    def __init__(self, time_step, channel):
        ...
        self.mix_layer1 = Mixer2dTriU(time_step, channel)
        self.mix_layer2 = Mixer2dTriU(time_step, channel)
